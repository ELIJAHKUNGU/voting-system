            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <?php
                            $votingstatus =  $row["voting-status"];
                            if ($votingstatus == 1) {
                            ?>
                        ...
                        <td>
                            <?php
                            $blacklist =  $row["blacklist-account"];
                            if ($blacklist == 1) {
                            ?>
                                <button class="btn btn-outline-danger">
                                    blacklisted
                        ...
                        <td style="width: 100px;"><a href="updateform.php?id=<?php echo $row["student-id"] ?>">
