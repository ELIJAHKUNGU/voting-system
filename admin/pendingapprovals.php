    ...
    <div class="table-responsive">
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                require 'db.php';
                $qry = "SELECT * FROM `students`  where `voting-status` = 0";
                ...
                ?>
                    <tr>
                        ...
                        <td style="width: 100px;"><a href="pendingform.php?id=<?php echo $row["student-id"] ?>"><button class="btn btn-outline-primary">
                                    Awaiting Approval
                                </button></a> </td>
