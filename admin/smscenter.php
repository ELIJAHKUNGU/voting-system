    ...
    <div class="table-responsive">
        <table class="table table-striped table-sm">
            ...
            <tbody>
                ...
                require 'db.php';
                $qry = "SELECT * FROM `students`  where `voting-status` = 1 and `graduate-status` = 0 and  `blacklist-account` = 0";
                ...
                ?>
                    <tr>
                        ...
                        <td style="width: 100px;"><a href="smsform.php?id=<?php echo $row["student-id"] ?>"><button class="btn btn-outline-primary">
                                    send Sms
                                </button></a> </td>
